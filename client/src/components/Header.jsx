    ...
    return (
        <motion.div initial={{opacity:0.2,y:100}} transition={{duration:1}} whileInView={{opacity:1,y:0}} viewport={{once:true}} className='flex flex-col justify-center items-center text-center my-20'>
            <motion.div initial={{opacity:0,y:-20}} animate={{opacity:1,y:0}} transition={{delay:0.2,duration:0.8}} className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500'>
                <p>Transform ideas into stunning visuals with AI-powered image generation!</p>
            ...
            initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{delay:0.6,duration:0.8}} 
             className='text-center max-w-xl max-auto mt-5'>Bring your imagination to life with AI-powered image generation.
                Create stunning visuals instantly with just a few words.
                Turn ideas into art effortlessly!</motion.p>
            <motion.button
            ...
            className='mt-2 text-neutral-600'>Generated images from kri$hna</motion.p>
